...
namespace The_Relic
{
    internal class ControllsMenuState : LoopState
    {
        Button upButton;
        Button downButton;
        Button leftButton;
        ...
        public ControllsMenuState(RenderWindow window) : base(window) { }
        ...
        protected override void Start()
        {
            ...
            FloatRect downTxtSize = upTxt.GetGlobalBounds();
            ...
            Vector2f rightTextPos = new Vector2f(firstListOffset - firstButtonOffsetX - leftTxtSize.Width, window.Size.Y / 6f + firstButtonOffsetY * 3);
            Vector2f cancelTextPos = new Vector2f(firstListOffset * 2 - firstButtonOffsetX - upTxtSize.Width, window.Size.Y / 6f);
            Vector2f fire1TextPos = new Vector2f(firstListOffset * 2 - firstButtonOffsetX - upTxtSize.Width, window.Size.Y / 6f + firstButtonOffsetY);
